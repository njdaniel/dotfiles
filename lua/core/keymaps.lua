...
keymap.set("n", "<leader>dx", "<cmd>lua require'dap'.terminate()<CR>", { noremap = true, silent = true })
keymap.set("n", "<leader>ds", "<cmd>lua require'dap-ui'.open()<CR>", { noremap = true, silent = true })
